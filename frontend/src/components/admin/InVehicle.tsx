...
type DataIndex = keyof InVehicleType;
...
const InVehicle: React.FC = () => {
  ...
  const getColumnSearchProps = (dataIndex: DataIndex): TableColumnType<InVehicleType> => ({
  ...
  const columns: TableColumnType<InVehicleType>[] = [
    {
      title: 'S.NO',
      dataIndex: 'index',
      key: 'index',
